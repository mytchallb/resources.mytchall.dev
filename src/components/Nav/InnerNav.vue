<template>
  <div class="fixed flex gap-2 justify-between items-center w-full p-1">
    <!-- Reset filters -->
    ...
    <div class="flex items-center gap-2 flex-shrink-0">
      ...
      <select class="bg-background h-full text-copy border-2 border-primary rounded-md p-2" :value="$sortBy" @change="(e) => sortBy.set(e.target.value)">
      ...
      <input
        ...
        "
        class="bg-background h-full min-w-20 w-full max-w-30 text-copy border-2 border-primary rounded-md p-2"
        placeholder="Search '/'"
      />
    </div>
  </div>
